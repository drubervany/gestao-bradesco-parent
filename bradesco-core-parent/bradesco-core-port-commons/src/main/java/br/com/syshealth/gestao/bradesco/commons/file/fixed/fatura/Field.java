...
import br.com.syshealth.gestao.bradesco.commons.file.fixed.fatura.utils.ReflectionUtils;
...
public class Field {
	...
	public enum TypeLine {
		HEADER, HEADERSUBFATURA, TITULARDEPENDENTE, TRAILLERSUBFATURA, TRAILLER, TRAILLEROBSERVACAO
	};
